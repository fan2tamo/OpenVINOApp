...
if %framework%==onnx (
    ...
    echo python mo.py --framework %framework% --input_model "%CurrentPath%\%ModelName%.pb" --output_dir "%CurrentPath%\OpenVINOApp\OpenVINOAppCpp\Data\Model" --b 1 --data_type %DataType% --scale_values [255,255,255]
    python mo.py --framework %framework% --input_model "%CurrentPath%\%ModelName%.pb" --output_dir "%CurrentPath%\OpenVINOApp\OpenVINOAppCpp\Data\Model" --b 1 --data_type %DataType% --scale_values [255,255,255]
) 
