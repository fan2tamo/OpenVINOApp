...
public:
    ...
    virtual void  InferCallBack(int inferID, const std::string &inputImageFile, bool isSuccessed, const std::vector<float> &results) = 0;
...
public:
    ...
    virtual int InferASync(const std::string &imageName)  = 0;
    virtual std::vector<float>InferSync(const std::string& imageName) = 0;
